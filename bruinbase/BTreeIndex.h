...
class BTreeIndex {
 public:
  ...
  RC insertRecur(int key, const RecordId& rid, int height, int currentPid, int& specialKey,int& specialPid);
  ...
  RC locateRecur(int& searchKey, IndexCursor& cursor, int height, PageId& next);
 ...
 private:
  ...
  //save page 0 as the default page that stores metadata of the B+ Tree
